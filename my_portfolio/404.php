...
<html lang="en">
    ...
    <body>
       ...
       <!--  <div id="spinner" class="show w-100 vh-100 bg-white position-fixed translate-middle top-50 start-50  d-flex align-items-center justify-content-center">
        ...
        <!-- Spinner End -->
        <!-- 404 Start -->
        <div class="container-fluid py-6 wow fadeInUp" id="home" data-wow-delay="0.1s">
            <div class="container text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <a class="btn btn-primary rounded-pill py-3 px-5" href="http://localhost/my_portfolio/">Go Back To Home</a>
                    </div>
                </div>
            </div>
        </div>
